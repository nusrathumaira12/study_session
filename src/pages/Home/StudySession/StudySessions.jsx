...
const StudySessions = () => {
  ...
  return (
   <div >
     <h2 className="text-3xl font-semibold md:ml-30 ml-5 mt-15">All the skills you need in one place</h2>
     <p className="text-xl mb-4 mt-2 md:ml-30 ml-5">From critical skills to technical topics, BrainBuddy supports your professional development.</p>
